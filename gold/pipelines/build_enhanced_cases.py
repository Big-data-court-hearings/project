...
output_yearly_summary   = ensure(GOLD_PATH / "active_cases_by_court_year.parquet")
output_quarterly_summary= ensure(GOLD_PATH / "active_cases_by_court_quarter.parquet")
