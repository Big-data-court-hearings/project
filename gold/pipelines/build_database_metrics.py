...
This script creates an enriched analytical dataset from a single specified 
Silver docket file, retaining only the most recent entry for each distinct 
case based on date_modified, without any cohort date restrictions.
"""
...
silver_files = (Path(SILVER_PATH) / "database_dockets_latest.parquet").as_posix()

output_file = GOLD_PATH / "database_case_metrics.parquet"
...
print("Building complete case metrics dataset...")
