...
BACKLOG_PATH = GOLD_PATH /  "backlog_evolution_by_quarter.parquet"
OUTPUT_PATH  = ensure(GOLD_PATH /"clearance_rate_by_quarter.parquet")
...
def main():
    ...
    df["clearance_rate_pct"] = (df["clearance_rate"] * 100).round(2)

    result = (
        df[["year_quarter", "circuit", "inflow", "outflow", "clearance_rate", "clearance_rate_pct"]]
